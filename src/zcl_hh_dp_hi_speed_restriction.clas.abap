CLASS zcl_hh_dp_hi_speed_restriction DEFINITION
  PUBLIC
  ...
  PRIVATE SECTION.
    constants:
      maximum_safe_speed_for_car type zcl_hh_dp_vehicle=>speed_type value 500,
      maximum_safe_speed_for_truck type zcl_hh_dp_vehicle=>speed_type value 35.
ENDCLASS.



CLASS zcl_hh_dp_hi_speed_restriction IMPLEMENTATION.
  METHOD visit_car.
