CLASS zcl_hh_dp_vehicle_option_cc DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    CONSTANTS:
      class_id TYPE seoclsname VALUE 'ZCL_HH_DP_VEHICLE_OPTION_CC'.
  ...
  PRIVATE SECTION.
    CONSTANTS:
      ...
      this_option_abbreviation TYPE zcl_hh_dp_vehicle=>description_type VALUE 'CC'.
ENDCLASS.



CLASS zcl_hh_dp_vehicle_option_cc IMPLEMENTATION.
  METHOD constructor.
