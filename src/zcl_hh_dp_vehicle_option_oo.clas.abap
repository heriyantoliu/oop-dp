class ZCL_HH_DP_VEHICLE_OPTION_OO definition
  public
...
public section.
  ...
  constants CLASS_ID type SEOCLSNAME value 'ZCL_HH_DP_VEHICLE_OPTION_OO'.
  ...
  PRIVATE SECTION.
    constants:
      this_option_weight type zcl_hh_dp_vehicle=>weight_unit_type value 211,
      this_option_weight_unit type msehi value 'LB',
      this_option_abbreviation type zcl_hh_dp_vehicle=>description_type value 'OO'.

ENDCLASS.



CLASS ZCL_HH_DP_VEHICLE_OPTION_OO IMPLEMENTATION.
