CLASS zcl_hh_dp_fog_restriction DEFINITION
  PUBLIC
  ...
  PRIVATE SECTION.
    constants:
      maximum_safe_speed_for_car type zcl_hh_dp_vehicle=>speed_type value 30,
      maximum_safe_speed_for_truck type zcl_hh_dp_vehicle=>speed_type value 25.
ENDCLASS.



CLASS zcl_hh_dp_fog_restriction IMPLEMENTATION.
